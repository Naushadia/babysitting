...
const signupController = async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: "<h3>OTP for account verification is </h3>" + "<h1 style='font-weight:bold;'>" + otp + "</h1>" + "<h3> Click this <a href='" + req.protocol + "://" + req.headers.host + "/users/verify/" + email + "'>link</a> to verify your email</h3>",
    });
...
const forgetPasswordController = async (req, res) => {
  ...
  try {
    ...
    if (!user) {
      ...
      return res.send(success(200,"we have sent instructions to reset password"));
    }
  } catch (e) {
    console.log(e);
    return res.send(error(400,"something went wrong"))
...
const resetPasswordController = async (req, res, next) => {
  ...
  if (req.body.new_password == req.body.confirm_password) {
    ...
    return res.send(error(400,"password should be matched"))
  }
};
...
const getNewpassword = async (req, res, next) => {
  ...
  try {
    ...
    if (decoded) {
      ...
      return res.send(success(200,"we have successfully reset your password"));
    } else {
